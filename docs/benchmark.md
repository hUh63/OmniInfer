...
OmniInfer emits benchmark Schema `1.3.0`, including its generator version,
prompt identity, per-run durations, standard methodology profile, and cache
policy. The website validator and
